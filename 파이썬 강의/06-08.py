...
yone.age = 30
print(f"나이 입력 후 : {yone}")

yone.greeting()
print(f"인사 후 : {yone}")

yone.add_age()
print(f"나이 추가 후 : {yone}")

yone.change_phone("010-5555-5555")
print(f"번호 교체 후 : {yone}")
...
class Calculator:
    ...
    def avg(self):
        call_sum = sum(self.list)
        count = len(self.list)
        return call_sum / count
